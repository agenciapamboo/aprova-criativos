                ...
                <section>
                    <div className="relative pt-24 md:pt-36">
                        <AnimatedGroup
                            ...
                            <img
                                src="https://images.unsplash.com/photo-1419242902214-272b3f66ee7a?w=3276&h=4095&fit=crop"
                                alt="background"
                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">Sistema de Aprovação de Conteúdos</span>
                                    ...
                                    <p
                                        ...
                                        Gerencie e aprove conteúdos de forma simples e eficiente. Controle total sobre o fluxo de aprovação de suas campanhas.
                                    </p>
                                </AnimatedGroup>
                                ...
                                <AnimatedGroup
                                    ...
                                    <Button
                                        ...
                                        <Link to="/dashboard">
                                            <span className="text-nowrap">Acessar Dashboard</span>
